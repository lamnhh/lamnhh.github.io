...
Challenge and solution source codes: [https://drive.google.com/drive/folders/16UlaxLtW11RAOBWNIMFGGw12wB8NsS04?usp=sharing](https://drive.google.com/drive/folders/16UlaxLtW11RAOBWNIMFGGw12wB8NsS04?usp=sharing)
...
- The target is to forge $$E(target)$$ with $$target = $$0x2020202020202020202020202020202020202020202020202020202020202020 (32 bytes 0x20). The catch is that we cannot query for $$E(target)$$ directly.
...
- $$E(2) \cdot E(2) \equiv 2^e \cdot 2^e \equiv 4^e \equiv E(4) \ (mod\ N) \Leftrightarrow E(2)^2 - E(4) \equiv 0\ (mod\ N)$$
- $$E(2) \cdot E(2) \cdot E(2) \equiv 2^e \cdot 2^e \cdot 2^e \equiv 8^e \equiv E(8)\ (mod\ N) \Leftrightarrow E(2)^3 - E(8) \equiv 0\ (mod\ N)$$

From that, we have:

$$N | GCD(E(2)^2 - E(4), E(2)^3 - E(8))$$
...
$$E(2target) \equiv E(2) \cdot E(target)\ (mod\ N) \Leftrightarrow E(target) \equiv E(2target) \cdot E(2)^{-1}\ (mod\ N)$$
