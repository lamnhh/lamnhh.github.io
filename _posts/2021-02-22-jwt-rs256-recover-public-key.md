...
Each of these part is base64-ed. Viewing the token on [jwt.io](jwt.io) gives:

![JWT](/assets/img/2021-02-22-jwt.png)

The signature is computed on `Header + "." + Payload`. The signing algorithm is specified in the raw header (in the sample above, it's RS256 - RSA with SHA256).
